...
Control.prototype.addTargetActionForControlEvents = function(aTarget, anAction, aControlEvent)
{
	...
	console.log("Target: " + aTarget.uniqueId() + " action: " + anAction + " for event: " + aControlEvent);
...
Control.prototype.didReceiveEvent = function(aControl, anEvent){
	var self = this;
	// For now, do nothing.
	console.log("Got generic event: " + aControl.identity() + ":" + aControl.uniqueId() + " event: " + anEvent);
};
