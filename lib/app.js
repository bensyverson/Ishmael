	...
	aVC.view.renderHTML(function(err, html){
		...
		if (err) {
			...
			myHTML = html 
					...
					+ 'console.log(Representable);'
					+ 'var Representable=Representable || null;'
					+ 'window.UserDefaults=null;'
					+ 'for (var i=0;i<p.length;i++){'
					+ ' try{Representable=require(p[i] + "ishmael.js");window.UserDefaults=require(p[i] + "userdefaults.js");}catch(e){}'
					...
					+ '};document.addEventListener("load",m);}())</script>';
		}
